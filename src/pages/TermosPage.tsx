    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="prose prose-gray max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            Aceitamos cartão de crédito (Visa, Mastercard, Elo, Amex, Hipercard, Diners), Pix, boleto bancário e cartão de débito. O parcelamento em até 12x sem juros está sujeito à análise de crédito pela operadora do cartão. Compras via Pix possuem desconto de 10%.
          </p>
