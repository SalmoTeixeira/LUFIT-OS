    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="prose prose-gray max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            Aceitamos cartão de crédito (Visa, Mastercard, Elo, Amex, Hipercard, Diners), Pix, boleto bancário e cartão de débito. Parcelamos em até 12x nos cartões de crédito. Os encargos de parcelamento são de responsabilidade da operadora do cartão do cliente, conforme condições comerciais de cada bandeira.
          </p>
