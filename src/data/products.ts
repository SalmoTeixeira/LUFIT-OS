...
export const products: Product[] = [
  ...
  {
    id: '63', name: 'Shorts Selene Push Up Preto', price: 44.90, image: '/produtos/short-1.jpg', images: ['/produtos/short-1.jpg', '/produtos/short-2.jpg'], category: 'selene', subcategory: 'Shorts', sizes: ['P', 'M', 'G'], colors: [{ name: 'Preto', hex: '#000000' }, { name: 'Rosa', hex: '#FF69B4' }, { name: 'Azul Marinho', hex: '#1a1a5e' }], description: 'Shorts Selene com efeito push up. Modelagem que valoriza a silhueta. Tecido sem costura e zero transparência.', specifications: ['Composição: 93% Poliamida, 7% Elastano', 'Efeito push up', 'Sem costura', 'Zero transparência'], rating: 4.5, reviewCount: 78, sku: 'SEL-SH-004',
  },
];
